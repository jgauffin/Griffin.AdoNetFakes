...
public class DataTableExtensionsTests
{
    ...
    public void ToTable_can_map_a_SimpleObject_instance()
    {
        ...
        var instances = new[]
        {
            new SimpleObject
            {
                Id = 1,
                Name = "Bob",
                DateOfBirth = DateTime.Parse("1995-06-23")
            }
        };
    ...
    public void ToTable_can_map_multiple_SimpleObject_instances()
    {
        ...
        var instances = new[]
        {
            ...
            new SimpleObject
            {
                Id = 3,
                Name = "Jim",
                DateOfBirth = DateTime.Parse("1994-02-18")
            },
            new SimpleObject
            {
                Id = 4,
    ...
    public void ToTable_can_map_a_SimpleObject_instance_and_only_include_specific_columns()
    {
        ...
        // Act
        var result =
            instances.ToDataTable(includedPropertyNames: new[] {nameof(SimpleObject.Id), nameof(SimpleObject.Name)});
