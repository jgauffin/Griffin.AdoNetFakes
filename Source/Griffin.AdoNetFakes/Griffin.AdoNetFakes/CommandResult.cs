namespace Griffin.AdoNetFakes
{
    ...
    public class CommandResult
    {
        ...
        /// <remarks>Use this constructor together with <see cref="FakeCommand.Setup"/> to enable
        /// automatic validation of executed commands.</remarks>
        public CommandResult(string commandText, ParameterCollection parameters)
        {
