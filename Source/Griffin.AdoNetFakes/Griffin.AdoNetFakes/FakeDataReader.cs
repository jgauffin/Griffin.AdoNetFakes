...
namespace Griffin.AdoNetFakes
{
    ...
    /// Fake reader
    /// </summary>
    /// <remarks>Uses a data table as the source.
    /// <para>Inherit and override <see cref="SchemaTable"/> or 
    /// override <see cref="Factory.CreateSchemaTable"/> to provide your
    /// own schema tables. An empty one is returned by default.</para>
    /// </remarks>
    public class FakeDataReader : IDataReader
    {
        ...
        protected DataTable SchemaTable
        {
            get
            {
                return _schemaTable ?? Factory.Instance.CreateSchemaTable(this);
            }
