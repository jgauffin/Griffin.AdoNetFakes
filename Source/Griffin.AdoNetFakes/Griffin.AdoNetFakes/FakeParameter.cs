...
public class FakeParameter : DbParameter
{
    ...
    ///     <see cref="T:System.Data.ParameterDirection" /> values.
    /// </exception>
    ...
    /// <summary>
    ///     Gets or sets the name of the source column mapped to the <see cref="T:System.Data.DataSet" /> and used for loading
    ///     or returning the <see cref="P:System.Data.Common.DbParameter.Value" />.
    /// </summary>
    /// <returns>
    ///     The name of the source column mapped to the <see cref="T:System.Data.DataSet" />. The default is an empty
    ///     string.
    /// </returns>
    ...
    ///     <see cref="T:System.Data.Common.DbCommandBuilder" /> to correctly generate Update statements for nullable columns.
    /// </summary>
    ...
    /// <exception cref="T:System.ArgumentException">
    ///     The property is not set to one of the
    ///     <see cref="T:System.Data.DataRowVersion" /> values.
    /// </exception>
    ...
    /// </summary>
    /// <returns>
    ///     The maximum number of digits used to represent the Value property of a data provider Parameter object. The
    ///     default value is 0, which indicates that a data provider sets the precision for Value.
    /// </returns>
    ...
    /// </summary>
    /// <returns>
    ///     The number of decimal places to which <see cref="T:System.Data.OleDb.OleDbParameter.Value" /> is resolved. The
    ///     default is 0.
    /// </returns>
